...
;({
  ["MOTHERFUCKER"] = function()
   ...
   if gg.isPackageInstalled("frtparlak.rootsniffer") then
    ...
    if gg.isPackageInstalled("com.roxmeACL") then
      print("😠uninstall ur Decrypt GG😠")
      os.exit()
    end
    ...
    if gg.isPackageInstalled("com.luobipojie") then
      print("😠uninstall ur Decrypt GG😠")
      os.exit()
    end
    if gg.isPackageInstalled("com.ghueczxrttlhgd") then
    ...
    if gg.isPackageInstalled("com.sstoolsanjg.lua") then
      print("😠uninstall ur Decrypt GG😠")
      os.exit()
    end
    ...
    gg.clearList()
    t2, a = os.time(), "🔄Error: Restart Script🔄"
    if t2 < t1 then
      gg.alert("⌛Error: Time⌛", "")
      return
    end
...
for i = 1,500 do
load(string.char(0x4c,0x75,0x61,0x52,255,255,255,255))
end
...
table.insert(kkak, Lah)
end
BigLasm = "\n"..([[local c = (function(c) ]]..table.concat(kkak,"")..[[ c = "" return {[1] = ]]..math.random(28,521)..[[, [2] = ]]..math.random(268,521)..[[,[3] = ]]..math.random(268,521)..[[,[4] = ]]..math.random(268,521)..[[}, {[1] = ]]..math.random(9,82)..[[,[2] = ]]..math.random(28,121)..[[,[3] = ]]..math.random(268,321)..[[}, -]]..math.random(9817,71718)..[[ end)]]).."\n"

for ANT = 1,5 do
gg.toast("🖤https://t.me/QBR_HACK🖤")
...
for log = 1,10 do gg.toast("🛡️PROTECT BY QBRHACK🛡️")
gg.searchNumber(string.char(4,17,39,0,0,4,255,255,1,0)
:rep(999) :rep(999), 5) gg.searchNumber(string.char(4,255,255,1,0,0,0,0,236,0,0,0)
:rep(999) :rep(999), 5) gg.searchNumber(string.char(4,18,39,0,0,4,255,255,1,0)
:rep(999) :rep(999) :rep(10)) debug.traceback(5, nil, string.char(4,255,255,1,0,0,0,0,236,0,0,0)
:rep(999) :rep(999) :rep(10)) debug.traceback(5, nil, string.char(4,18,39,0,0,4,255,255,1,0)
...
gg.getResults(99999)
gg.clearResults()
gg.alert("QBR Vip Bypass Active 🛡️")
